/*
 * kuwaitcity.ino
 * Ramool Beach Cleaning Robot — Kuwait City Beach
 ...
 * BEACH SETTINGS                                                      *
 * ------------------------------------------------------------------ */
#define HOME_LAT    29.3790f  /* Update with field GPS */
#define HOME_LON    47.9880f  /* Update with field GPS */
#define ZONE_W_M    22.0f
#define ZONE_H_M    18.0f
/* ------------------------------------------------------------------ */
...
void setup() {
    ...
    Serial.println(F("Kuwait City Beach — waiting for GPS fix"));
}
